 ...
 * 		hash:8057e7e2c615be2edddb, chunkhash:bc3e31705566b0cb9297, name:mobile, filebase:mobile.0.0.1902-2.ja.js, query:, file:mobile.0.0.1902-2.ja.js
 */
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var riot = __webpack_require__(0)
    riot.tag2('mk-ui-nav', '<div class="backdrop" onclick="{parent.toggleDrawer}"></div><div class="body"><a class="me" if="{SIGNIN}" href="{\'/\' + I.username}"><img class="avatar" riot-src="{I.avatar_url + \'?thumbnail&size=128\'}" alt="avatar"><p class="name">{I.name}</p></a><div class="links"><ul><li class="home"><a href="/"><i class="icon fa fa-home"></i>ホーム<i class="angle fa fa-angle-right"></i></a></li><li class="notifications"><a href="/i/notifications"><i class="icon fa fa-bell-o"></i>通知<i class="angle fa fa-angle-right"></i></a></li><li class="messaging"><a href="/i/messaging"><i class="icon fa fa-comments-o"></i>メッセージ<i class="angle fa fa-angle-right"></i></a></li></ul><ul><li class="settings"><a onclick="{search}"><i class="icon fa fa-search"></i>検索<i class="angle fa fa-angle-right"></i></a></li></ul><ul><li class="settings"><a href="/i/drive"><i class="icon fa fa-cloud"></i>ドライブ<i class="angle fa fa-angle-right"></i></a></li></ul><ul><li class="settings"><a href="/i/settings"><i class="icon fa fa-cog"></i>設定<i class="angle fa fa-angle-right"></i></a></li></ul></div><a href="{CONFIG.aboutUrl}"><p class="about">Misskeyについて</p></a></div>', 'mk-ui-nav,[data-is="mk-ui-nav"]{display:none;} mk-ui-nav .backdrop,[data-is="mk-ui-nav"] .backdrop{position:fixed;top:0;left:0;z-index:1025;width:100%;height:100%;background:rgba(0,0,0,0.2)} mk-ui-nav .body,[data-is="mk-ui-nav"] .body{position:fixed;top:0;left:0;z-index:1026;width:240px;height:100%;overflow:auto;color:#777;background:#fff} mk-ui-nav .me,[data-is="mk-ui-nav"] .me{display:block;margin:0;padding:16px;} mk-ui-nav .me .avatar,[data-is="mk-ui-nav"] .me .avatar{display:inline;max-width:64px;border-radius:32px;vertical-align:middle} mk-ui-nav .me .name,[data-is="mk-ui-nav"] .me .name{display:block;margin:0 16px;position:absolute;top:0;left:80px;padding:0;width:calc(100% - 112px);color:#777;line-height:96px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap} mk-ui-nav ul,[data-is="mk-ui-nav"] ul{display:block;margin:16px 0;padding:0;list-style:none;} mk-ui-nav ul:first-child,[data-is="mk-ui-nav"] ul:first-child{margin-top:0} mk-ui-nav ul li,[data-is="mk-ui-nav"] ul li{display:block;font-size:1em;line-height:1em;} mk-ui-nav ul li a,[data-is="mk-ui-nav"] ul li a{display:block;padding:0 20px;line-height:3rem;line-height:calc(1rem + 30px);color:#777;text-decoration:none;} mk-ui-nav ul li a > .icon,[data-is="mk-ui-nav"] ul li a > .icon{margin-right:.5em} mk-ui-nav ul li a > .angle,[data-is="mk-ui-nav"] ul li a > .angle{position:absolute;top:0;right:0;padding:0 20px;font-size:1.2em;line-height:calc(1rem + 30px);color:#ccc} mk-ui-nav .about,[data-is="mk-ui-nav"] .about{margin:0;padding:1em 0;text-align:center;font-size:.8em;opacity:.5;} mk-ui-nav .about a,[data-is="mk-ui-nav"] .about a{color:#777}', '', function(opts) {
		this.mixin('i');
		this.mixin('page');
